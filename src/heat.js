...
function initializeMap() {
  ...
  function showInfoWindow(data, x, y) {
    ...
    // 为导航按钮添加点击事件
    var dirBtn = infoWindow.querySelector('.direction-button');
    if (dirBtn) {
